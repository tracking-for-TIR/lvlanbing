# /home/upup/lv/program/siamfc-pytorch-dmeo/siamfc-pytorch-master/SiamDW

import torch
import torch.nn as nn
import torch.nn.functional as F
from collections import OrderedDict
from Attention.mbv2 import CoordAtt,InvertedResidual
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, last_relu, stride=1, stride2pool=False, dilation=1):
        ...
        for i in range(1, blocks):
            mbv2 = CoordAtt
            if i == blocks - 1:
                layers.append(CoordAtt(self.inplanes, self.inplanes))
...
if __name__ == "__main__":
    ...
    net = ResNet(Bottleneck_CI,[3,4],[True, False],[False,True])
    print(net)
    output = net(z)
    print(output.shape)
